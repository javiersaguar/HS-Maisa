...
export function EtapaCard({ etapa, ficheros }: { etapa: EtapaResumen; ficheros: number }) {
  ...
  return (
    <Card className="group w-[min(390px,calc(100vw-64px))] shrink-0 p-5 transition hover:-translate-y-0.5 hover:border-accent">
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          <div className="flex size-10 items-center justify-center bg-raised text-accent-dark transition-transform duration-300 group-hover:scale-105">
      ...
      <Link
        ...
        className="mt-5 flex w-full items-center justify-center gap-1 border border-line py-2 text-[14px] font-semibold text-accent-dark transition"
      >
