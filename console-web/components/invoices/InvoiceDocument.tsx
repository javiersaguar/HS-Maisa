  ...
  return (
    <Card className="flex min-h-[690px] flex-col overflow-hidden border-line shadow-[0_8px_30px_rgba(43,55,51,0.05)]">
      ...
      <div className="flex-1 overflow-auto bg-raised p-5 sm:p-8">
        <div
          ref={pageRef}
          className="relative mx-auto flex min-h-[610px] max-w-[820px] flex-col overflow-hidden border border-line bg-surface p-7 shadow-[0_4px_14px_rgba(43,55,51,0.08)] transition-transform duration-200 ease-out"
        ...
        >
          {!hechos && (
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-10 bg-surface/60">
              ...
              <span className="absolute right-3 top-3 bg-warn-soft px-2.5 py-1 text-[11px] font-semibold text-warn">
          ...
          {hechos?.texto_sospechoso && (
            <div className="mt-5 border border-dashed border-warn-line bg-warn-soft px-3 py-2">
