      ...
      {tooltip && tip
        ? createPortal(
            <span
              id={tipId}
              role="tooltip"
              className={`pointer-events-none fixed z-[80] w-max max-w-[260px] -translate-y-1/2 rounded-[var(--radius-ui)] bg-[#17211e] px-3 py-1.5 text-left text-[12px] font-medium leading-snug text-white ${
