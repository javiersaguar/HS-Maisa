...
- Mismo nombre, otro contenido, otro lote (P0-5): entra en `ficheros` como `./X.pdf` (`db.PREFIJO_INTERNO`) y su nombre de entrega en `identidades`; tiene sus propios hechos y decisión. `package` y la auditoría saltan el interno; `trace X.pdf --lote 2` elige cuál.
