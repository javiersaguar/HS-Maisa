...
- El repo de entrega (`ENTREGA_REPO` en .env) contiene **exactamente** `outcomes.jsonl`, `outcomes_lote2.jsonl` y `albertitos_plan.pdf` en la raíz. Nada más: ni README, ni código, ni .gitignore.
