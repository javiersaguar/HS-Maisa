...
| 443 PAGAR / 48 ESCALAR / 9 NO_PAGAR | Decisiones vigentes lote 1, norma v3, ERP v1 | BD real; [KIT-DEFENSA](agentes/KIT-DEFENSA.md) | C1; `uv run albertitos status` | 19/09, G2 | Referencia actual; cambiará si Mónica cambia política; no verdad etiquetada |
