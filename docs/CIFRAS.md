...
| 23 PAGAR / 16 ESCALAR / 1 NO_PAGAR | Sólo lote 2, norma v4 y ERP v2 | entrega `d2ade3f`; ADR-0022 | C1 | 20/09 00:17 | 8 de los 16 escalados son facturas en divisa; **7 se entregan citando la moneda** (v4.R7) y `e11_P011.pdf` se entrega por su IBAN (v4.R1), que es el motivo principal. Sin tabla de cambio no convertimos. Pendiente de mentores |
